<x-app-layout>
    <div class="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 dark:from-gray-900 dark:to-purple-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-8 transition-all duration-300 hover:shadow-xl">
                <form method="GET" action="{{ route('shop.bundles') }}" class="space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row justify-end items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-6">
                        ...
                        <button type="submit" 
                                class="w-full sm:w-auto px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300">
                            Apply Filters
                        </button>
                    </div>
                </form>
            ...
            @if($bundles->isEmpty())
                <!-- Empty State -->
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 text-center max-w-lg mx-auto">
            ...
            @else
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($bundles as $bundle)
                        <div class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl transform hover:-translate-y-2">
                            <!-- Bundle Image -->
                            <div class="relative h-64 bg-purple-100 dark:bg-gray-700 overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-2 mb-6">
                                    ...
                                    <div class="flex items-center text-purple-600 dark:text-purple-400">
                                        ...
                                        <span class="font-bold">${{ number_format($bundle->price, 2) }}</span>
                                    </div>
                                ...
                                <a href="{{ route('bundles.show', $bundle->id) }}" 
                                   class="block w-full text-center px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-500 text-white rounded-lg hover:from-purple-700 hover:to-indigo-600 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300">
                                    View Bundle
                                </a>
                            </div>
                        </div>
