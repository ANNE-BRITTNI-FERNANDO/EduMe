                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="mt-2 space-y-2">
                                ...
                                <p><span class="font-medium">Seller:</span> {{ $product->user->name }}</p>
                        ...
                        @if($product->resubmitted)
                            <div class="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                                <h3 class="text-lg font-semibold text-yellow-800 dark:text-yellow-200">Resubmission</h3>
                                <p class="mt-2 text-yellow-600 dark:text-yellow-400">This product has been resubmitted for review after previous rejection.</p>
                            </div>
                        @endif
                    </div>
                </div>
