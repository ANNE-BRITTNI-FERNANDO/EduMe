                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="font-black text-xl flex items-center space-x-2">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-4.35-4.35m2.39-5.14a7 7 0 11-14 0 7 7 0 0114 0z" />
                        </svg>
                        <!-- Link Text -->
                        <span>{{ __('EduME') }}</span>
                    </x-nav-link>
                    ...
                    @auth
                        <x-nav-link :href="route('seller.earnings.index')" :active="request()->routeIs('seller.earnings.*')" class="flex items-center space-x-2">
